...
namespace UriTemplateTests
{
    public class UriTemplateTableTests
    {
        ...
        {
            var
                table = new UriTemplateTable(); // Shorter paths and literal path segments should be added to the table first.
        ...
        {
            var
                table = new UriTemplateTable(); // More restrictive templates should have priority over less restrictuve ones
